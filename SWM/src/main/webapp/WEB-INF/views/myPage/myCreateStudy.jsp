...
<c:import url="../common/header.jsp"/>
	<div id="container" data-id="myarticle">
    	<h1 class="mypagearticlesname">내가 개설한 스터디</h1>
    		<c:choose>
				<c:when test="${fn:length(myCreateStudy) > 0}">
    			<c:forEach items="${myCreateStudy}" var="list">
    				...
    				<div data-v-70332c88>
  					...
  					<div data-v-70332c88 class="container" style >
      					...
      					<input type="hidden" name="meeting_no" value="${list.meeting_no }"/>
         					<a data-v-70332c88 href="/meeting/meetingDetail?meeting_no=${list.meeting_no}" class="item">
    	...
    	<a data-v-7c8cb348 class="item" style="margin:20px" >
									...
									<h1 data-v-7c8cb348="" style="text-align:center; margin:30px">개설한 스터디가 없습니다</h1>
